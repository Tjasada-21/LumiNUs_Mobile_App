...
import {
  registerBrandedAlertHandler,
  unregisterBrandedAlertHandler,
} from "../services/brandedAlert";
...
const BrandedAlertHost = () => {
  ...
  const buttons = useMemo(
    () => alertState?.buttons ?? defaultButtons,
    [alertState],
  );
  const accentColor =
  ...
  return (
    ...
    >
      <Pressable
        ...
        onPress={alertState?.cancelable ? hideAlert : undefined}
      >
