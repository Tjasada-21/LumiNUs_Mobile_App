...
const GlobalSearchScreen = ({ navigation, route }) => {
  ...
  const renderResult = ({ item }) => {
    ...
    const year = item?.year_graduated
      ? `Class of ${String(item.year_graduated).slice(0, 4)}`
      : "Class year not listed";
    ...
    return (
      ...
      >
        ...
        <View style={styles.resultBody}>
          ...
          <Text style={styles.resultSubmeta} numberOfLines={1}>
            {year}
          </Text>
        </View>
        <Pressable
        ...
        >
          <Text
            style={[
              ...
              actionDisabled ? styles.actionButtonTextDisabled : null,
            ]}
          >
            {actionLabel}
          </Text>
    ...
    <View style={styles.headerCard}>
      <View style={styles.titleRow}>
        ...
        <View style={styles.titleWrap}>
          ...
          <Text style={styles.subtitle}>
            Search alumni by name, year of graduation, or program.
          </Text>
        </View>
      </View>
      ...
      <View style={styles.helperRow}>
        <Text style={styles.helperText}>
          Try a name, class year, or program like BSIT.
        </Text>
        <Text style={styles.helperCount}>
          {query.trim()
            ? `${visibleAlumni.length} result${visibleAlumni.length === 1 ? "" : "s"}`
  ...
  const listEmpty = () => {
      ...
      return (
        <View style={styles.emptyCard}>
          ...
          <Text style={styles.emptyText}>
            Use the search bar above to find alumni by name, graduation year, or
            program, then send a connection request.
          </Text>
        </View>
      );
    }
    ...
    return (
      <View style={styles.emptyCard}>
        ...
        <Text style={styles.emptyText}>
          Try a different spelling, year, or program.
        </Text>
      </View>
    );
  };
