            ...
            <View style={styles.eventCard}>
              {eventImageUri ? (
                ...
                <View style={styles.eventBannerFallback}>
                  ...
                  <Text style={styles.eventBannerFallbackText}>
                    Registration
                  </Text>
                </View>
              )}
              ...
              <View style={styles.privacyCard}>
                ...
                <View style={styles.choiceGroup}>
                  <Pressable
                    ...
                    accessibilityState={{ checked: privacyConsent === "agree" }}
                  >
                    <View style={styles.choiceIcon}>
                      <Ionicons
                        ...
                        size={18}
                        color={
                          privacyConsent === "agree" ? "#31429B" : "#B4B4B4"
                        }
                      />
                    </View>
                  ...
                  >
                    <View style={styles.choiceIcon}>
                      <Ionicons
                        ...
                        size={18}
                        color={
                          privacyConsent === "disagree" ? "#31429B" : "#B4B4B4"
                        }
                      />
                    </View>
              ...
              <View style={styles.confirmationCard}>
                <Text style={styles.confirmationText}>
                  I hereby confirm my attendance for the selected alumni events.
                  I understand that my slot is reserved upon submission, and I
                  am willing to comply with the event guidelines and schedules
                  set by the NU Lipa Alumni Affairs Office.
                </Text>
                ...
                <Pressable
                  ...
                  accessibilityState={{ checked: attendanceConsent }}
                >
                  <View style={styles.choiceIcon}>
                    <Ionicons
                      name={
                      ...
                      size={18}
                      color={attendanceConsent ? "#31429B" : "#B4B4B4"}
                    />
                  </View>
                  <Text style={styles.choiceText}>I agree</Text>
                </Pressable>
