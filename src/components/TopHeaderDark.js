...
const TopHeaderDark = () => {
  ...
  return (
    ...
    <View style={styles.transparentWrapper} pointerEvents="box-none">
      <View style={[styles.darkContainer, { minHeight: layout.cardMinHeight }]}>
        <View style={styles.logoContainer}>
          <Image
            source={require("../../assets/images/NU Lipa AAO Logo white.png")}
            style={[
              styles.leftLogo,
...
const styles = StyleSheet.create({
  transparentWrapper: {
    ...
    // REMOVED top and horizontal padding so the dark container touches the edges
    paddingBottom: 24, // Keeps space below for the shadow to render without cutting off
    zIndex: 1000, 
  },
  darkContainer: {
    backgroundColor: "#1F2B67", // Applied the requested deep blue background
    alignItems: "center",
    justifyContent: "flex-end", // Pushes logos safely below the notch
    
    // Moved the notch padding INSIDE the dark box so it extends behind your device's status bar
